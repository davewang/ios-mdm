...
echo ""
echo "6. server key and server crt  to  java keystore"
...
keytool -importcert -v -trustcacerts  -alias ca_root -file cacert.crt  -keystore server.jks
keytool -importcert -v -alias identity -file identity.crt -keystore server.jks
