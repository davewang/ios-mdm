 ...
 * 
 */
package com.sinonet.mdm.service.impl;
...
import com.sinonet.mdm.model.User;
...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.sinonet.mdm.service.impl.PasswordTokenManager#generateRecoveryToken(com.sinonet.mdm.model.User)
     */
    @Override
    ...
    /**
     * @see com.sinonet.mdm.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.sinonet.mdm.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.sinonet.mdm.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
